...
La premiere étape consiste à extraire les processus présents dans la machine mémoire :
...
Le code montre que la chaine de C2 est chiffrée avec un XOR entre `enc` et une clé.
...
En regardant le premier offset, on voit la clé en clair juste avant les octets chiffrés :
...
Avec la clé, le domaine de C2 se déchiffre avec un XOR.
